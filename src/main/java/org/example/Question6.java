...
public class Question6 extends JFrame {
    ...
    private void startConversion() {
        ...
        currentWorker = new SwingWorker<>() {
            ...
            protected void done() {
                ...
                cancelButton.setEnabled(false);
                if (!isCancelled()) {
                    JOptionPane.showMessageDialog(Question6.this, "Conversion completed!", "Info", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(Question6.this, "Conversion cancelled!", "Info", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        };
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            Question6 converterGUI = new Question6();
